	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装1" src="images/女装1.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装2" src="images/女装2.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装3" src="images/女装3.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装4" src="images/女装4.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装5" src="images/女装5.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="女装6" src="images/女装6.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
