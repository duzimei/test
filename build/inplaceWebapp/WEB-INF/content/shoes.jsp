	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-4">
					<div class="tupian">
						<img alt="鞋子1" src="images/鞋子1.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="鞋子2" src="images/鞋子2.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="鞋子3" src="images/鞋子3.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="tupian">
						<img alt="包包4" src="images/包包1.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="包包5" src="images/包包2.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="包包6" src="images/包包3.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
