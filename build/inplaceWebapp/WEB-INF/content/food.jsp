...
<html lang="en">
  ...
  <body background="images/背景二.jpg">
				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-4">
							...
							<address>
								 <strong>管理员呵呵</strong><br> 欢迎您的光临！<br> 您是今天在线的1位顾客之一
							</address>
						</div>
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食1" src="images/美食1.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
							...
							<p>
								<a class="btn btn-primary" href="#">购买</a> <a class="btn" href="#">详情</a>
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食2" src="images/美食2.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食3" src="images/美食3.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食4" src="images/美食4.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食5" src="images/美食5.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
				...
				<div class="col-md-4">
					<div class="tupian">
						<img alt="美食6" src="images/美食6.jpg">
						<div class="caption">
							<h3>
								Thumbnail label
							</h3>
